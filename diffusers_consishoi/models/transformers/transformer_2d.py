...
class Transformer2DModel(LegacyModelMixin, LegacyConfigMixin):
    ...
    def forward(
        ...
        ###########################
        # import pdb; pdb.set_trace() # debug height and weight
        cross_attention_kwargs["hidden_states_height"] = hidden_states.shape[2]
        cross_attention_kwargs["hidden_states_width"] = hidden_states.shape[3]
        ###########################
